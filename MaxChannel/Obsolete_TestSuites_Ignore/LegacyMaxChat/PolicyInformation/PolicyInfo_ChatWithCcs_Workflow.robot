...
...               AND    Select the MaxChat policyInfo Chat With A Care Specialist option
...
* Test Cases
TC_01_Verify Policy Information Flow: Chat With CCS option
    [Tags]    Ignore    E-xxx    B-xxx
    Would you like to chat with a MaxChat Policy Information CCS
