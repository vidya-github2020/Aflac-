...
Test Setup        Begin a MaxChat Learn About A Letter flow
...
* Test Cases
TC_01_Verify Learn About A Letter Flow: Helpful - No; CCS - No
...
TC_02_Verify Learn About A Letter Flow: Helpful - No; CCS - Yes; Survey - No
    [Tags]    Ignore    E-xxx    B-xxx
    Was the information helpful in answering your question in the MaxChat    No
...
TC_03_Verify Learn About A Letter Flow: Helpful - No; CCS - Yes; Survey - Yes
    [Tags]    Ignore    E-xxx    B-xxx
    Was the information helpful in answering your question in the MaxChat    No
    Would you like to connect to a MaxChat ccs for further assistance    Yes
    Check if you are required to connect to the MaxChat ccs
...
TC_04_Verify Learn About A Letter Flow: Helpful - Yes; Assitance - No
    [Tags]    Ignore    E-xxx    B-xxx
...
TC_05_Verify Learn About A Letter Flow: Helpful - Yes; Assitance - Yes
    [Tags]    Ignore    E-xxx    B-xxx
    Was the information helpful in answering your question in the MaxChat    Yes
    Is there something else you need assistance with in the MaxChat    Yes

# TC_06_Verify Learn About A Letter Flow: Url Redirect
#     [Tags]    E-xxx    B-xxx
#     Verify that the URL opens in a new browser tab    ${link_clickHere}    ${url_learnAboutALetter}
