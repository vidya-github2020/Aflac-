...
...               AND    Select the MaxChat Claim Center Was My Fax Received option
...
* Test Cases
TC_01_Verify Claim Center Flow: Was My Fax Received; Helpful - No; CCS - No
...
TC_02_Verify Claim Center Flow: Was My Fax Received; Helpful - No; CCS - Yes; Survey - No
    [Tags]    Ignore    E-xxx    B-xxx
    Was the information helpful in answering your question in the MaxChat    No
...
TC_03_Verify Claim Center Flow: Was My Fax Received: Helpful - No; CCS - Yes; Survey - Yes
    [Tags]    Ignore    E-xxx    B-xxx
    Was the information helpful in answering your question in the MaxChat    No
    Would you like to connect to a MaxChat ccs for further assistance    Yes
    Check if you are required to connect to the MaxChat ccs
...
TC_04_Verify Claim Center Flow: Was My Fax Received; Helpful - Yes; Assitance - No
    [Tags]    Ignore    E-xxx    B-xxx
...
TC_05_Verify Claim Center Flow: Was My Fax Received: Helpful - Yes; Assitance - Yes
    [Tags]    Ignore    E-xxx    B-xxx
    Was the information helpful in answering your question in the MaxChat    Yes
