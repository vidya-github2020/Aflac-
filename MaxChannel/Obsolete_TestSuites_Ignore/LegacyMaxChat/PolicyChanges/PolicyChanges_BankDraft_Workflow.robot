...
...               AND    Select the MaxChat Policy Changes Bank Draft option
...
* Test Cases
TC_01_Verify Policy Changes Flow: Bank Draft; Helpful - No; CCS - No
...
TC_02_Verify Policy Changes Flow: Bank Draft; Helpful - No; CCS - Yes; Survey - No
    [Tags]    Ignore    ystTest    E-xxx    B-xxx
    Was the information helpful in answering your question in the MaxChat    No
...
TC_03_Verify Policy Changes Flow: Bank Draft: Helpful - No; CCS - Yes; Survey - Yes
    [Tags]    Ignore    SystTest    E-xxx    B-xxx
    Was the information helpful in answering your question in the MaxChat    No
    Would you like to connect to a MaxChat ccs for further assistance    Yes
    Check if you are required to connect to the MaxChat ccs
...
TC_04_Verify Policy Changes Flow: Bank Draft; Helpful - Yes; Assitance - No
    [Tags]    Ignore    SystTest    E-xxx    B-xxx
...
TC_05_Verify Policy Changes Flow: Bank Draft: Helpful - Yes; Assitance - Yes
    [Tags]    Ignore    SystTest    E-xxx    B-xxx
    Was the information helpful in answering your question in the MaxChat    Yes
