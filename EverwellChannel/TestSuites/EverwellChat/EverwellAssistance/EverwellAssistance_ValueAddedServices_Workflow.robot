...
...               AND    Select the EverwellChat Everwell Assistance Value Added Services option
...
* Test Cases
TC_01_Verify Everwell Assistance Flow: Value Added Services option; Connect to CCS - NO; Further Help - NO
    [Tags]    E-xxx    B-xxx
    Connect to an EverwellChat CCS    No
    Do you require further assistance in the EverwellChat    No

TC_02_Verify Everwell Assistance Flow: Value Added Services option; Connect to CCS - NO; Further Help - YES
    [Tags]    E-xxx    B-xxx
    Connect to an EverwellChat CCS    No
    Do you require further assistance in the EverwellChat    Yes

TC_03_Verify Everwell Assistance Flow: Value Added Services option; Connect to CCS - YES; CCS Not Available
