...
* Test Cases
TC_01_Verify Everwell Group Assistance Flow: Access - NO; Connect to CCS - NO; Further Help - NO
    [Tags]    E-xxx    B-xxx
...
TC_02_Verify Everwell Group Assistance Flow: Access - NO; Connect to CCS - NO; Further Help - Yes
    [Tags]    E-xxx    B-xxx
    Select the EverwellChat Group Assistance option and confirm no access to the account and connect to CCS    No
    Do you require further assistance in the EverwellChat    Yes

TC_03_Verify Everwell Group Assistance Flow: Access - NO; Connect to CCS - YES; CCS Not Available
    [Tags]    E-xxx    B-xxx     Ignore
    Select the EverwellChat Group Assistance option and confirm no access to the account and connect to CCS    Yes
