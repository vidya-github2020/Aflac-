...
* Test Cases
TC_01_Verify Everwell Group Assistance Flow: Access - YES; Plan Year; Connect to CCS - NO; Further Help - NO
    [Tags]    E-xxx    B-xxx
    Select the EverwellChat Group Assistance Plan Year option and connect to CCS    No
    Do you require further assistance in the EverwellChat    No

TC_02_Verify Everwell Group Assistance Flow: Access - YES; Plan Year; Connect to CCS - NO; Further Help - YES
    [Tags]    E-xxx    B-xxx
    Select the EverwellChat Group Assistance Plan Year option and connect to CCS    No
    Do you require further assistance in the EverwellChat    Yes

TC_03_Verify Everwell Group Assistance Flow: Access - YES; Plan Year; Connect to CCS - YES; CCS Not Available
    [Tags]    E-xxx    B-xxx    Ignore
    Select the EverwellChat Group Assistance Plan Year option and connect to CCS    Yes
