#Introduction To Policy Holder
What is the purpose of the Policy Holder ChatBot?? ...
...
Navigate to the root folder of the PolicyHolder project in a cmd window, ie: 
...
-> ie: robot --outputdir ./Output PolicyHolderChannel/TestSuites/PolicyHolderChannel/Basic_Functionality/Branding.robot 
-> This will run all tests in Branding test suite and store the results in the ./Output folder directory

To run parallel tests:
1. pabot --processes 2 --exclude Ignore --outputdir ./Output/IntG/ ../PolicyHolderChannel/TestSuites/PolicyHolderChannel
  -> This will run all tests, 2 at a time, and ignore tests tagged with Ignore
2. pabot --processes 2 --exclude Ignore --include Run_In_SysT --outputdir ./Output/SysT ../PolicyHolderChannel/TestSuites/PolicyHolderChannel
...
1. robot --exclude Ignore --rerunfailedsuites Output/IntG/output.xml --outputdir ./Output/IntG/rerun --output rerun.xml ../PolicyHolderChannel/TestSuites/PolicyHolderChannel
2. robot --exclude Ignore --rerunfailed Output/IntG/output.xml --outputdir ./Output/IntG/rerun --output rerun.xml ../PolicyHolderChannel/TestSuites/PolicyHolderChannel
...
#Contribute
The Robot Tests for PAVE - Policy Holder Chat Channel will be stored on GitHub: 
